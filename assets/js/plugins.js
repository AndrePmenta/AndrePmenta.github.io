...
!function(e, n, t, o) {
    ...
    e.fn.pagepiling = function(i) {
        var a, s = e.fn.pagepiling, c = e(this), r = 0, l = "ontouchstart"in t || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, p = 0, d = 0, v = 0, h = 0, u = [], f = 600, m = e.extend(!0, {
            direction: "vertical",
            menu: null,
            verticalCentered: !0,
            sectionsColor: [],
        ...
        s.setMouseWheelScrolling = function(e) {
            e ? c.get(0).addEventListener ? (c.get(0).addEventListener("mousewheel", k, !1),
            c.get(0).addEventListener("wheel", k, !1)) : c.get(0).attachEvent("onmousewheel", k) : c.get(0).addEventListener ? (c.get(0).removeEventListener("mousewheel", k, !1),
            c.get(0).removeEventListener("wheel", k, !1)) : c.get(0).detachEvent("onmousewheel", k)
        }
        ,
        s.setAllowScrolling = function(e) {
            e ? (s.setMouseWheelScrolling(!0),
            function() {
                if (l) {
                    var e = I();
            ...
            function() {
                if (l) {
                    var e = I();
                    c.off("touchstart " + e.down),
                    c.off("touchmove " + e.move)
                }
            }())
        }
        ,
        ...
        m.css3 && (m.css3 = function() {
            ...
            for (var s in n.body.insertBefore(i, null),
            a)
                i.style[s] !== o && (i.style[s] = "translate3d(1px,1px,1px)",
        ...
        e.isEmptyObject(m.navigation) || function() {
            ...
            for (var t = 0; t < e(".pp-section").length; t++) {
                var o = "";
                if (m.anchors.length && (o = m.anchors[t]),
        ...
        function S(n, t) {
            var o, i = {
                ...
                toMove: n,
                yMovement: (o = n,
                e(".pp-section.active").index(".pp-section") > o.index(".pp-section") ? "up" : "down"),
                leavingSection: e(".pp-section.active").index(".pp-section") + 1
            };
            if (!i.activeSection.is(n)) {
                var s, c, l;
                void 0 === i.animated && (i.animated = !0),
                void 0 !== i.anchorLink && (s = i.anchorLink,
                c = i.sectionIndex,
                m.anchors.length ? (location.hash = s,
                M(location.hash)) : M(String(c))),
                ...
                i.sectionsToMove = function(n) {
                    ...
                    t = "down" === n.yMovement ? e(".pp-section").map(function(t) {
                        if (t < n.destination.index(".pp-section"))
                            return e(this)
                ...
                "down" === i.yMovement ? (i.translate3d = q(),
                i.scrolling = "-100%",
                m.css3 || i.sectionsToMove.each(function(n) {
                    n != i.activeSection.index(".pp-section") && e(this).css(x(i.scrolling))
                }),
                i.animateSection = i.activeSection) : (i.translate3d = "translate3d(0px, 0px, 0px)",
                i.scrolling = "0",
                i.animateSection = n),
                e.isFunction(m.onLeave) && m.onLeave.call(this, i.leavingSection, i.sectionIndex + 1, i.yMovement),
                function(n) {
                    m.css3 ? (T(n.animateSection, n.translate3d, n.animated),
                    n.sectionsToMove.each(function() {
                        T(e(this), n.translate3d, n.animated)
                    }),
                    setTimeout(function() {
                        w(n)
                    }, m.scrollingSpeed)) : (n.scrollOptions = x(n.scrolling),
                    n.animated ? n.animateSection.animate(n.scrollOptions, m.scrollingSpeed, m.easing, function() {
                        b(n),
                        w(n)
                ...
                l = i.anchorLink,
                m.menu && (e(m.menu).find(".active").removeClass("active"),
                e(m.menu).find('[data-menuanchor="' + l + '"]').addClass("active")),
                function(n, t) {
                    m.navigation && (e("#pp-nav").find(".active").removeClass("active"),
                    n ? e("#pp-nav").find('a[href="#' + n + '"]').addClass("active") : e("#pp-nav").find("li").eq(t).find("a").addClass("active"))
        ...
        function M(n) {
            n = n.replace("#", ""),
            e("body")[0].className = e("body")[0].className.replace(/\b\s?pp-viewing-[^\s]+\b/g, ""),
        ...
        e(".pp-section").each(function(n) {
            ...
            n || 0 !== e(".pp-section.active").length || e(this).addClass("active"),
            void 0 !== m.anchors[n] && e(this).attr("data-anchor", m.anchors[n]),
            void 0 !== m.sectionsColor[n] && e(this).css("background-color", m.sectionsColor[n]),
            m.verticalCentered && !e(this).hasClass("pp-scrollable") && e(this).addClass("pp-table").wrapInner('<div class="pp-tableCell" style="height:100%" />'),
            g -= 1
        }).promise().done(function() {
            m.navigation && (e("#pp-nav").css("margin-top", "-" + e("#pp-nav").height() / 2 + "px"),
            e("#pp-nav").find("li").eq(e(".pp-section.active").index(".pp-section")).find("a").addClass("active")),
            e(t).on("load", function() {
                var o, i;
                o = t.location.hash.replace("#", ""),
                (i = e(n).find('.pp-section[data-anchor="' + o + '"]')).length > 0 && S(i, m.animateAnchor)
            }),
        ...
        e(t).on("hashchange", function() {
            ...
            if (o.length) {
                if (o && o !== a)
                    S(isNaN(o) ? e(n).find('[data-anchor="' + o + '"]') : e(".pp-section").eq(o - 1))
            }
        }),
        ...
        function k(n) {
            ...
            !y()) {
                ...
                return E(u, 10) >= E(u, 70) && c && (a < 0 ? L("down", l) : a > 0 && L("up", l)),
                !1
            }
        }
        function E(e, n) {
        ...
        function N(n) {
            ...
            if (!function n(t, o) {
                ...
                if (o.length || n.preventDefault(),
                !y()) {
                    var i = X(t);
                    v = i.y,
                    h = i.x,
                    "horizontal" === m.direction && Math.abs(d - h) > Math.abs(p - v) ? Math.abs(d - h) > c.width() / 100 * m.touchSensitivity && (d > h ? L("down", o) : h > d && L("up", o)) : Math.abs(p - v) > c.height() / 100 * m.touchSensitivity && (p > v ? L("down", o) : v > p && L("up", o))
                }
            }
        }
        function q() {
...
!function(t, e) {
            ...
            return n(t, [{
                ...
                value: function(t, e) {
                    ...
                    !0 !== this.pause.status ? this.timeout = setTimeout(function() {
                        ...
                        if ("`" === o.charAt(0)) {
                            for (; "`" !== t.substr(e + i).charAt(0) && !(e + ++i > t.length); )
                                ;
    ...
    , function(t, e, s) {
        ...
        var r, o = s(2), a = (r = o) && r.__esModule ? r : {
            default: r
        }, u = function() {
            function t() {
                !function(t, e) {
